...
if(isset($_POST['title']) AND isset($_POST['description']) AND isset($_POST['image']) AND isset($_POST['url'])){
    ...
    try{
        $rs = $con->prepare("INSERT INTO news ( title, description , image, url ) VALUES ( ?, ?, ?, ? )");
        $rs->execute([$title,$description,$image, $url]);
...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    try{
        $rs = $con->prepare("delete from news where id = ?");
        $rs->execute([$id]);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        <a class="nav-link active" aria-current="page" href="./adminhome.php">News</a>
        <a class="nav-link" href="./admin_nutrition.php">Nutrition</a>
        <a class="nav-link"  href="./admin_mentalite.php">Mentalite</a>
        <a class="nav-link"  href="./admin_communication.php">Communication</a>
        
      </div>

      <dib class="d-flex ms-auto">
...
<tr>
<td colspan="2"><center><h1>Add News</h1></center></td>
</tr>
...
<tr>
    <td><label for="exampleFormControlInput1" class="form-label" style="font-size : 18px;">Image url </label> </td>
<td> 
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="image">
...
<tr>
    <td><label for="exampleFormControlInput1" class="form-label" style="font-size : 18px;">News url </label> </td>
<td> 
...
<table class="table table-dark table-borderless">
  ...
  <tbody class="table-light">
    <?php 
    $rs = $con->prepare("select * from news");
    $rs->execute();
    ...
    <tr>
        ...
        <td> <?php echo $url; ?> </td>
        <td><a href="./adminhome.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
    </tr>
