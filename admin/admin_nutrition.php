...
if(isset($_POST['title']) AND isset($_POST['description']) AND isset($_POST['image']) AND isset($_POST['url'])){
    ...
    try{
        $rs = $con->prepare("INSERT INTO nutrition ( title, description , image, url ) VALUES ( ?, ?, ?, ? )");
...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    try{
        $rs = $con->prepare("delete from nutrition where id = ?");
        $rs->execute([$id]);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        ...
        <a class="nav-link active"  href="./admin_nutrition.php">Nutrition</a>
...
<tr>
<td colspan="2"><center><h1>Add Nutrition</h1></center></td>
</tr>
...
<table class="table table-dark table-borderless">
  ...
  <tbody class="table-light">
    ...
    <tr>
        ...
        <td> <?php echo $url; ?> </td>
        <td><a href="./admin_nutrition.php?id=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
    </tr>
