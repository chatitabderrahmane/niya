...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-cumst bg-gradient ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="player_home.php">Acceuil</a>
                  </li>
      ...
      <div style="margin: 30px;" class="row row-cols-1 row-cols-md-4 g-15">
          ...
          <div class="col">
            <div class="card shadow ">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo $url;  ?>" class="btn btn-success" >Read more</a>
              </div>
            </div>
          </div>
